...
export const MyActivity = () => {
  ...
  const { data: dataCompleteAppointment } = useGetCountAppointmentComplete(
    userUUid,
    authToken
  )
  const { data: dataCancelAppointment } = useGetCountAppointmentCancel(
    userUUid,
    authToken
  )
  const { data: dataAllAppointment } = useGetCountAllAppointments(
    userUUid,
    authToken
  )
  return (
